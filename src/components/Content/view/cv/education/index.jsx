...
const Education = () => (
  <div className="education">
    ...
    <p className="education__vuz">
      <span className="education__qualify">Master of computer science<br/> Engineer researcher</span>
      <br />
      East Ukrainian National University. Automated technological process control.
    </p>
    <p className="education__vuz">
